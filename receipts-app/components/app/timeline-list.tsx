...
export function TimelineList({
  ...
  const hasFilters = Boolean(query || type !== "all" || mood !== "all" || range !== "all");
  ...
  return (
    <section className="rounded-[2rem] border border-white/10 bg-white/5 p-4 sm:p-6">
      ...
      <form className="mt-6 grid gap-x-4 gap-y-4 rounded-[1.8rem] border border-[#4f4338] bg-[#15120f]/85 p-4 md:grid-cols-2 xl:grid-cols-[minmax(0,1fr)_170px_170px_170px_auto] xl:items-end">
        ...
        <div className="space-y-2">
          <label htmlFor="timeline-type" className="text-xs uppercase tracking-[0.24em] text-zinc-500">
            Entry type
          </label>
          <select
            id="timeline-type"
        ...
        <div className="space-y-2">
          <label htmlFor="timeline-range" className="text-xs uppercase tracking-[0.24em] text-zinc-500">
            Time range
          </label>
          <select
            id="timeline-range"
        ...
        <div className="flex flex-wrap gap-2 xl:justify-end">
          <button className="rounded-full bg-amber-300 px-5 py-3 font-semibold text-black">
            Search
          </button>
          {hasFilters ? (
