...
export function GenerateInsightsButton({ scope = "week", periodKey }: { scope?: "week" | "month"; periodKey?: string }) {
  ...
  return (
    <div className="flex flex-col items-end gap-2">
      <button
        onClick={() => {
          startTransition(async () => {
            const result = await generateInsights(scope, periodKey);
      ...
      >
        {pending ? "Generating..." : scope === "month" ? "Generate this month" : periodKey ? "Generate this week" : "Generate insights"}
      </button>
