...
import { archiveEntry, restoreEntry } from "@/app/journal/entry-actions";
import { ReceiptsConfirmDialog } from "@/components/ui/receipts-confirm-dialog";

export function ManageNoteMenu({
  entryId,
  dateKey,
  archived = false,
  ...
  return (
    <>
      <div className="mt-3 flex flex-col items-start gap-2">
        ...
        <Link href={archived ? "/journal/archive" : `/journal/${dateKey}`} className="text-xs text-zinc-500 transition hover:text-zinc-300">
